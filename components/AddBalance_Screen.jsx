...
const AddBalance_Screen = ({ navigation }) => {
  ...
  const mode_ofIncome = [
    { id: 1, mode: "Job" },
    { id: 2, mode: "Business" },
    { id: 3, mode: "Part Time Job" },
    { id: 4, mode: "Pocket Money" },
    { id: 5, mode: "Savings" },
  ...
  const saveIncome = async () => {
    ...
    await AsyncStorage.setItem("income", JSON.stringify(incomes));
    navigation.goBack();
  };
          ...
          <ScrollView
            ...
            <View className="mt-4">
              ...
              <View className=" justify-center items-center mt-4">
                ...
                activeOpacity={0.7}
                onPress={()=>saveIncome()}>
                  <Text className="text-black text-lg font-bold" allowFontScaling={false}>Add Income </Text>
                </TouchableOpacity>
              </View>
            </View>
          </ScrollView>
...
export default AddBalance_Screen